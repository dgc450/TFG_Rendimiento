...
csv_dir_hotspot = os.path.join(mainDirectory, "CSV_hotspotHW")
os.makedirs(csv_dir_hotspot, exist_ok=True)
csv_dir_bfs = os.path.join(mainDirectory, "CSV_bfsHW")
os.makedirs(csv_dir_bfs, exist_ok=True)
csv_dir_lavaMD = os.path.join(mainDirectory, "CSV_lavaMDHW")
os.makedirs(csv_dir_lavaMD, exist_ok=True)
csv_dir_cfd = os.path.join(mainDirectory, "CSV_cfdHW")
os.makedirs(csv_dir_cfd, exist_ok=True)
csv_dir_backprop = os.path.join(mainDirectory, "CSV_backpropHW")
os.makedirs(csv_dir_backprop, exist_ok=True)
csv_dir_gemm = os.path.join(mainDirectory, "CSV_gemmHW")
os.makedirs(csv_dir_gemm, exist_ok=True)
csv_dir_convolution3d = os.path.join(mainDirectory, "CSV_convolution-3dHW")
os.makedirs(csv_dir_convolution3d, exist_ok=True)
csv_dir_jacobi2d = os.path.join(mainDirectory, "CSV_jacobi-2dHW")
os.makedirs(csv_dir_jacobi2d, exist_ok=True)
csv_dir_spmv = os.path.join(mainDirectory, "CSV_spmvHW")
